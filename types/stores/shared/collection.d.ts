...
import { IMapperPartial, IPredicatePartial, IUpdatePartial } from "../../util/shared/functional";
 ...
 * @param start
 */
export declare function collection<T extends object>(store?: Writable<T[]> | T[], start?: IStoreStartStopNotifier<T[]>): ICollectionStore<T>;
