...
var browser_1 = require("../shared/browser");
 ...
 * @param replace
 */
function update_url(url, hash, replace) {
    if (hash === void 0) { hash = false; }
