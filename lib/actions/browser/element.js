...
var DEPRECATE_ATTRIBUTES = false;
var DEPRECATE_CLASSES = false;
/**
...
function attribute_passthrough(whitelist) {
    if (!DEPRECATE_ATTRIBUTES) {
        console.warn("[svelte-commons] DEPRECATE: `attribute_passthrough` is deprecated, use prop spread");
...
function class_passthrough(class_list) {
    if (!DEPRECATE_CLASSES) {
        console.warn("[svelte-commons] DEPRECATE: `class_passthrough` is deprecated, use `map_classes` instead");
